...
\usetikzlibrary{angles, arrows.meta, calc, graphs, math, shapes.geometric, through, trees}
\usepackage{polski}
\usepackage{array}
\usepackage{float}
\usepackage{caption}
...
\usepackage[final, colorlinks=true, linkcolor=black, citecolor=black, urlcolor=darkgray, pdfauthor={Antoni Zasada}]{hyperref} 
\usepackage{cleveref}
...
% Tikz
\tikzstyle{graphvertex}=[circle,fill,minimum size=0.25cm,inner sep=0]
\tikzstyle{graphedge}=[sloped,above,font=\footnotesize]
